...
//            Toast.makeText(this,"hello",Toast.LENGTH_SHORT).show()
            data = FirebaseDatabase.getInstance().getReference("PhieuThue").child(idP.toString())
...
//                      CapNhatTinhTrang(ds[0].IdPhong.toString())
                        Toast.makeText(this@PhieuThuePhong,"Id phòng là ${ds.size}",Toast.LENGTH_SHORT).show()
...
//
    ...
    fun CapNhatTinhTrang(){
       val data1 = FirebaseDatabase.getInstance().getReference("Phong").child("101")
